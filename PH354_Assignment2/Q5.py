# Exercise 5: Error in trapezoidal rule

# ANSWERS
# The errors do not agree perfectly because the estimated error is only till O(h**4). We should get a
...
for idx in range(len(I)):
    I[idx] = trap_int_func(function_1, a, b, n[idx])
Error = (I[1] - I[0])/(((n[1] - 1)/(n[0] - 1))**2 - 1)
print("Trapezoidal integration with n = " + str(n[0]) + ":")
print(I[0])
print("Trapezoidal integration with n = " + str(n[1]) + ":")
print(I[1])
